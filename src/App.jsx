...
import { 
  ChevronRight, Plus, Trash2, Users, Crown, Gamepad2, CheckSquare, 
  Square, ThumbsUp, ThumbsDown, ArrowLeft, Swords, PartyPopper, 
  Copy, LogIn, PlusCircle, Sparkles, RefreshCw, Shield, Check, Home, LogOut
} from 'lucide-react';
...
import { 
  ...
  getDoc, collection, query, where, runTransaction 
} from "firebase/firestore";

// --- FIREBASE CONFIG ---
const firebaseConfig = typeof __firebase_config !== 'undefined' ? JSON.parse(__firebase_config) : {};
const appId = typeof __app_id !== 'undefined' ? __app_id : 'fun-zone-default';
...
const ScreenWrapper = ({ children }) => (
  <div className="bg-slate-950 text-white min-h-screen font-sans flex flex-col items-center justify-center p-4">
